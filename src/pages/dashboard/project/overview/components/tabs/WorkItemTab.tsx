...
import { fetchWorkItems } from "../../services/work_item_services/FetchWorkItems"
import { deleteWorkItem } from "../../services/work_item_services/DeleteWorkItem"
import { updateWorkItem } from "../../services/work_item_services/UpdateWorkItem"
import type { WorkItem } from "../../services/work_item_services/FetchWorkItems"
import toast from "react-hot-toast"

// Import the components
import { DeleteConfirmationDialog } from "../work_item_components/DeleteConfirmationDialog"
import { WorkItemDetailDrawer } from "../work_item_components/WorkItemDetailDrawer"
import { WorkItemListSkeleton } from "../work_item_components/WorkItemListSkeleton"
import { WorkItemForm } from "../work_item_components/WorkItemForm"
import ProjectTableView, { type SortConfigItem } from "../work_item_views/ProjectTableView"
import ProjectKanbanView from "../work_item_views/ProjectKanbanView"
...
export function WorkItemTab() {
    ...
    const updateWorkItemPriority = async (itemId: number, newPriority: WorkItem['priority']) => {
        ...
        try {
            await updateWorkItem(itemId, { priority: newPriority });
            const item = prevWorkItems.find(i => i.id === itemId);
            toast.success(
